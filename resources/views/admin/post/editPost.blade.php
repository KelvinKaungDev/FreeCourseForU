    ...
    <div class="container col-md-7">
        <form method="post" class="p-5 border m-5" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="ph_number"  name="ph_number" value="{{$course->ph_number}}">
            </div>
            <div class="form-group">
            ...
            <div class="row justify-content-end no-gutters">
                ...
                <button type="submit" class="btn text-white btn-warning ml-3">Update</button>
            </div>
        </form>
    </div>
@endsection
